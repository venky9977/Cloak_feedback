...
const DashboardPage = () => {
  ...
  const fetchMessages = useCallback(async (refresh: boolean = false) => {
    ...
    try {
      ...
      await animationDelay; // Ensure the loading state lasts at least 1 second
      setIsLoading(false);
      setIsSwitchLoading(false);
    }
  }, [toast]);
  ...
  if (!session || !session.user) {
    return <div className="text-center text-red-600">Please Login</div>;
  }
    ...
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      ...
      <div className="mb-4 flex items-center">
        <Switch
          ...
          aria-label="Toggle Accept Messages"
        />
        <span className="ml-2">
